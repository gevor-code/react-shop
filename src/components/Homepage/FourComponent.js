...
const FourComponent = () => {
    ...
    return (
        <div className="main-container  flex flex-col items-center slider slidDiv ">
            <div className="flex items-center gap-4 flex-col mt-[3rem] ">
                ...
                <h1 className="text-[#274C5B] font-[Roboto] text-5xl font-extrabold leading-10  textSlider">Our Products</h1>
            </div>
            ...
            <div className="grid grid-cols-1  mb-[3rem]  mt-[3rem]">
                    ...
                    <div className="imgPart">
                        <div className="overflow-hidden shadow-lg rounded-sm bg-[#f9f8f8]  ">
                            ...
                            <img className="w-full h-60 sm:h-64 md:h-64 lg:h-[17rem] xl:h-[17rem]"
                                 src="/assets/images/broccoli.svg" alt="Sunset in the mountains"/>
                            <div className="px-6 py-4 flex justify-center">
                                <div
                                    className="text-xl gap-4 text-[#274C5B] font-semibold leading-6 font-[Roboto] ">Calabrese
                                    Broccoli
                                </div>
                ...
                <div className="imgPart">
                    <div className=" overflow-hidden shadow-lg rounded-sm bg-[#f9f8f8]  ">
                        ...
                        <div className="px-6 py-4">
                            <div className="text-xl gap-4 text-[#274C5B] text-center font-semibold leading-6 font-[Roboto] ">Fresh Banana Fruites</div>
                ...
                <div className="imgPart">
                    <div className="overflow-hidden shadow-lg rounded-sm bg-[#f9f8f8]  ">
                        ...
                        <div className="px-6 py-4">
                            <div className="text-xl gap-4 text-[#274C5B] text-center font-semibold leading-6 font-[Roboto] ">White Nuts</div>
                ...
                <div className="imgPart">
                    <div className=" overflow-hidden shadow-lg rounded-sm bg-[#f9f8f8]  ">
                        ...
                        <div className="px-6 py-4">
                            <div className="text-xl gap-4 text-[#274C5B] text-center font-semibold leading-6 font-[Roboto] ">Vegan Red Tomato</div>
                ...
                <div className="imgPart">
                    ...
                    <div className=" overflow-hidden shadow-lg rounded-sm bg-[#f9f8f8]  ">
                        ...
                        <div className="px-6 py-4">
                            <div className="text-xl gap-4 text-[#274C5B] text-center font-semibold leading-6 font-[Roboto] ">Mung Bean</div>
                ...
                <div className="imgPart">
                    <div className=" overflow-hidden shadow-lg rounded-sm bg-[#f9f8f8]  ">
                        ...
                        <div className="px-6 py-4">
                            <div className="text-xl gap-4 text-[#274C5B] text-center font-semibold leading-6 font-[Roboto] ">Brown Hazelnut</div>
                ...
                <div className="imgPart">
                    ...
                    <div className=" overflow-hidden shadow-lg rounded-sm bg-[#f9f8f8]  ">
                        ...
                        <div className="px-6 py-4">
                            <div className="text-xl gap-4 text-[#274C5B] text-center font-semibold leading-6 font-[Roboto] ">Eggs</div>
                ...
                <div className="imgPart">
                    <div className=" overflow-hidden shadow-lg rounded-sm bg-[#f9f8f8]  ">
                        ...
                        <div className="px-6 py-4 ">
                            <div className="text-xl gap-4 text-[#274C5B] text-center font-semibold leading-6 font-[Roboto] ">Zelco Suji Elaichi Rusk</div>
