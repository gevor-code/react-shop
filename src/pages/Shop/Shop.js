    ...
    const handleCategorySelection = async (category) => {
        ...
        try {
            if (updatedSelectedCategory.length === 0) {
                ...
                const dataProduct = await dispatch(getProducts({
                    callType: "withCategory",
            ...
            <div className="flex my-[5rem]  sm:gap-[25px] md:gap-[16px] lg:gap-[14px] xl:gap-[25px] ">
                ...
                <div>
                    <div
                        ...
                        <button
                            className="flex justify-between w-[160px]  cursor-pointer  rounded-[5px] bg-[#5552a2] text-white text-[16px] font-semibold p-3"
                            onClick={toggleDiv}>
                            Sort by{" "}
                            <span>
                      {isOpen ? (
